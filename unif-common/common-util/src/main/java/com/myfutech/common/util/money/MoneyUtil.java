...
* @Package com.qiandao.sale.util
* @Description: TODO
* @author Administrator
* @date 2018年10月24日
* @version V1.0
*/
package com.myfutech.common.util.money;
...
public class MoneyUtil {
	...
	*/
	...
	System.out.println("你输入的金额为：【" + money + "】 #--# [" + MoneyUtil.number2CNMontrayUnit(numberOfMoney).toString() + "]");
